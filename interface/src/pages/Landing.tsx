      ...
      <main className="grow pt-40 pb-20">
        ...
        <section className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-24 relative">
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-8 z-10">
            ...
            >
              <button
                className="glow-button font-label-mono text-label-mono bg-inverse-primary text-on-primary px-8 py-4 rounded-DEFAULT transition-all duration-300 hover:scale-[1.02] border-t border-white/20 flex items-center gap-2 shadow-2xl shadow-indigo-500/30"
