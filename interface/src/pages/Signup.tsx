            ...
            {viewState === "signup" && (
              ...
              >
                ...
                >
                  ...
                  <button
                    className="mt-4 w-full glow-button bg-inverse-primary text-on-primary font-label-mono text-label-mono py-4 px-4 rounded-lg transition-all duration-300 border-t border-on-surface/20 shadow-xl shadow-indigo-500/20 hover:scale-[1.02]"
                    type="submit"
                  >
                    Get API key
                  </button>
            ...
            {viewState === "key" && (
              ...
              >
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="bg-surface-container-lowest/80 border border-on-surface/10 rounded-lg flex items-center justify-between p-1.5 pl-4 group hover:border-on-surface/20 transition-colors">
                    ...
                    <button
                      className={`h-10 w-10 flex items-center justify-center rounded-md transition-colors ${
                        keyCopied
                          ...
                          : "text-on-surface/60 hover:text-on-surface hover:bg-on-surface/10"
                      }`}
                      id="btn-copy"
                ...
                <button
                  className={`mt-4 w-full font-label-mono text-label-mono py-4 px-4 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 ${
                    !keyCopied && !isSubmitting
                      ? "bg-on-surface/5 border border-on-surface/10 text-on-surface/40 cursor-not-allowed"
                      : "bg-inverse-primary text-on-primary border-t border-on-surface/20 glow-button shadow-xl shadow-indigo-500/20 hover:scale-[1.02]"
                  }`}
                  disabled={!keyCopied}
                  id="btn-continue"
